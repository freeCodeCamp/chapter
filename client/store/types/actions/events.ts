...
export const UPDATE_START = 'fcc/chapter/EVENT_UPDATE_START';
export const UPDATE_SUCCESS = 'fcc/chapter/EVENT_UPDATE_SUCCESS';
export const UPDATE_FAIL = 'fcc/chapter/EVENT_UPDATE_FAIL';
