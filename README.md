...
| ------------- | ------------- | ----- |
| _instance_      | a web server deployment of the ["Chapter" application](https://github.com/freeCodeCamp/chapter/), managed by an organization. | a Docker container running on a web host |
...
| _administrator_ | a role to manage the entire ["Chapter" application](https://github.com/freeCodeCamp/chapter/) _instance_ for an _organization_ | Women Who Code Global - Chapter _Administrator_ |
| _organizer_ | a role to manage a _chapter's_ _events_, RSVPs, communications, and _users_ | Women Who Code - New York City, Local _Organizer_ |
| _user_ | the role of a person who can follow and receive notifications from a _chapter_ and RSVP to _events_  | _User_ Sally Gold - SallyG@example.com |
