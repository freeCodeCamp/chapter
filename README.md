...
| ------------- | ------------- | ----- |
| _instance__      | a web server deployment of this _Chapter_ application, managed by an organization. | a Docker container running on a web host |
...
| _administrator_ | a role to manage the entire _Chapter_ application _instance_ for an _organization_ | Women Who Code Global - Chapter Administrator |
| _organizer_ | a role to manage a _chapter's_ _events_, RSVPs, and _users_ | Women Who Code - New York City, Local Organizer |
