...
export class DeleteTagsOnEventDelete1581810905311
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tags" ADD CONSTRAINT "FK_fd793b86b010970181e155eb750" FOREIGN KEY ("event_id") REFERENCES "events"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
      undefined,
    );
  }
