...
export class SocialProviderUser1575819370018 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(`ALTER TABLE "social_provider_users" DROP CONSTRAINT "FK_88dbf6a43ed7af106b6d63f0c74"`, undefined);
    await queryRunner.query(`ALTER TABLE "social_provider_users" DROP CONSTRAINT "FK_917ed23863f4248c814f6c7f36a"`, undefined);
